                ...
                <div className='w-[100%]'>
                    ...
                    <div className="relative">
                        <button onClick={applySearch}
                                className="text-white absolute left-2.5 bottom-2.5 bg-neutral-500 hover:bg-neutral-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2">جستجو
                        </button>
                        <input type="text"
