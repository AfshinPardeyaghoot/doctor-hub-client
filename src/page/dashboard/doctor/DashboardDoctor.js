            ...
            <div
                ...
                <div className='flex flex-row py-2 my-2 items-center justify-center'>
                    <div className='flex flex-col mx-5'>
                        <div className='text-gray-800 text-m px-3 mt-1 rtl w-80 text-start '>{doctor.name}</div>
                        <div className='text-gray-700 text-s px-3 mt-1 w-80 text-end'>{doctor.speciality.title}</div>
                    </div>
