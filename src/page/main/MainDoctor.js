function MainDoctor({doctor}) {
    return (
        <div>
            <div className="flex flex-row justify-end m-2 bg-slate-100 items-center h-24 md:w-96 w-72">
                ...
                <div className="pr-3">
                    <img className="h-16 w-16 rounded-full border-4 border-green-400 border-double" src={doctor.profileImage} alt="error"/>
                </div>
            </div>
        </div>
    )
