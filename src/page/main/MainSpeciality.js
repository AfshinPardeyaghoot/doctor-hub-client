    ...
    return (
        <div>
            <div
                ...
                <img className="h-16 w-16 visible md:invisible md:h-0 md:w-0" src={speciality.imageDownloadUrl}
                     alt='error'/>
                ...
                <div className="invisible h-0 w-0 flex flex-col justify-center items-end md:visible md:h-32 md:w-80">
                    <div
                        className="text-m text-gray-800 pr-3 flex items-center h-10 mt-6 mb-2">{speciality.fullTitle}</div>
                    <div className="text-[13px] text-gray-500 flex h-16 pr-3">{speciality.description}</div>
                </div>
                <img className="h-0 w-0 md:h-16 md:w-16 invisible md:visible" src={speciality.imageDownloadUrl}
                     alt='error'/>
            </div>
        </div>
    )
