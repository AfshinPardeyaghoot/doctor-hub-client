function MainSpeciality({speciality}) {
    return (
        <div>
            <div className="flex flex-col h-32 w-32 p-3 m-3 justify-center items-center bg-slate-100 md:w-96 md:flex-row md:justify-end transform transition duration-300 hover:scale-110">
