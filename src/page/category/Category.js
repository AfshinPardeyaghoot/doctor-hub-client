function Category({category}) {
    ...
    return (
        <div>
            <div
                className="flex flex-col items-center justify-center bg-white w-[20rem] md:w-[23rem] mt-5 md:mx-3 md:my-2 transform transition duration-300 hover:scale-110">
