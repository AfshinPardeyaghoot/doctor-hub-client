function TextMessage({isOwner, content}) {
    return (
        <p className={isOwner ? 'bg-green-600 rtl text-gray-100 p-[5px] text-start rounded-t-2xl px-3 rounded-l-2xl' : 'bg-white p-[5px] px-3 text-end rounded-t-2xl rtl rounded-r-2xl'}>{content}
